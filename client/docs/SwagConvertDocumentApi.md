...
[**convertDocumentDocxToDoc**](SwagConvertDocumentApi.md#convertDocumentDocxToDoc) | **POST** /convert/docx/to/doc | Convert Word DOCX Document to Legacy Word DOC (97-03)
...
[**convertDocumentPptxToPpt**](SwagConvertDocumentApi.md#convertDocumentPptxToPpt) | **POST** /convert/pptx/to/ppt | Convert PowerPoint PPTX presentation to Legacy PowerPoint PPT (97-03)
...
[**convertDocumentXlsxToXls**](SwagConvertDocumentApi.md#convertDocumentXlsxToXls) | **POST** /convert/xlsx/to/xls | Convert Excel XLSX Spreadsheet to Legacy Excel XLS (97-03)
...
> Blob convertDocumentCsvToHtml(inputFile)
...
try {
    // cross your fingers
    Blob result = api.convertDocumentCsvToHtml(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
> Blob convertDocumentDocxToDoc(inputFile)
...
try {
    // cross your fingers
    Blob result = api.convertDocumentDocxToDoc(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
try {
    // cross your fingers
    Object result = api.convertDocumentPptxToPpt();
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagRtfToJpgResult**](SwagRtfToJpgResult.md)
...
> SwagRtfToPngResult convertDocumentRtfToPng(inputFile)
...
try {
    // cross your fingers
    SwagRtfToPngResult result = api.convertDocumentRtfToPng(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagRtfToPngResult**](SwagRtfToPngResult.md)
...
> SwagCsvCollection convertDocumentXlsxToCsvMulti(inputFile, outputEncoding)
...
try {
    // cross your fingers
    SwagCsvCollection result = api.convertDocumentXlsxToCsvMulti(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagCsvCollection**](SwagCsvCollection.md)
...
> Blob convertDocumentXlsxToHtml(inputFile)
...
try {
    // cross your fingers
    Blob result = api.convertDocumentXlsxToHtml(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
<a name="convertDocumentXlsxToXls"></a>
# **convertDocumentXlsxToXls**
> Blob convertDocumentXlsxToXls(inputFile)
...
try {
    // cross your fingers
    Blob result = api.convertDocumentXlsxToXls(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
