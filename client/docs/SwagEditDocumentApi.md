...
[**editDocumentDocxAcceptAllTrackChanges**](SwagEditDocumentApi.md#editDocumentDocxAcceptAllTrackChanges) | **POST** /convert/edit/docx/track-changes/accept-all | Accept all tracked changes, revisions in a Word DOCX document
...
[**editDocumentDocxDisableTrackChanges**](SwagEditDocumentApi.md#editDocumentDocxDisableTrackChanges) | **POST** /convert/edit/docx/track-changes/disable | Disable track changes, revisions in a Word DOCX document
[**editDocumentDocxEnableTrackChanges**](SwagEditDocumentApi.md#editDocumentDocxEnableTrackChanges) | **POST** /convert/edit/docx/track-changes/enable | Enable track changes, revisions in a Word DOCX document
...
[**editDocumentDocxGetContentControls**](SwagEditDocumentApi.md#editDocumentDocxGetContentControls) | **POST** /convert/edit/docx/get-content-controls | Get all content controls (form fields) and values in a Word DOCX document
[**editDocumentDocxGetFormFields**](SwagEditDocumentApi.md#editDocumentDocxGetFormFields) | **POST** /convert/edit/docx/get-form-fields | Get all form fields in a Word DOCX document
...
[**editDocumentDocxGetMacroInformation**](SwagEditDocumentApi.md#editDocumentDocxGetMacroInformation) | **POST** /convert/edit/docx/get-macros | Get macro information from a Word DOCX/DOCM document
...
[**editDocumentDocxRemoveAllComments**](SwagEditDocumentApi.md#editDocumentDocxRemoveAllComments) | **POST** /convert/edit/docx/comments/remove-all | Remove all comments from a Word DOCX document
...
[**editDocumentDocxSetFormFields**](SwagEditDocumentApi.md#editDocumentDocxSetFormFields) | **POST** /convert/edit/docx/set-form-fields | Set and fill values for form fields in a Word DOCX document
...
[**editDocumentPptxGetMacroInformation**](SwagEditDocumentApi.md#editDocumentPptxGetMacroInformation) | **POST** /convert/edit/pptx/get-macros | Get macro information from a PowerPoint PPTX/PPTM presentation document
...
[**editDocumentXlsxGetMacroInformation**](SwagEditDocumentApi.md#editDocumentXlsxGetMacroInformation) | **POST** /convert/edit/xlsx/get-macros | Get macro information from a Excel XLSX/XLSM spreadsheet, worksheet
...
try {
    // cross your fingers
    Blob result = api.editDocumentDocxAcceptAllTrackChanges(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
try {
    // cross your fingers
    Blob result = api.editDocumentDocxDisableTrackChanges(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
try {
    // cross your fingers
    Blob result = api.editDocumentDocxEnableTrackChanges(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
> SwagGetDocxContentControlsResponse editDocumentDocxGetContentControls(inputFile)
...
try {
    // cross your fingers
    SwagGetDocxContentControlsResponse result = api.editDocumentDocxGetContentControls(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagGetDocxContentControlsResponse**](SwagGetDocxContentControlsResponse.md)
...
> SwagGetDocxGetFormFieldsResponse editDocumentDocxGetFormFields(inputFile)
...
try {
    // cross your fingers
    SwagGetDocxGetFormFieldsResponse result = api.editDocumentDocxGetFormFields(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagGetDocxGetFormFieldsResponse**](SwagGetDocxGetFormFieldsResponse.md)
...
> SwagGetMacrosResponse editDocumentDocxGetMacroInformation(inputFile)
...
try {
    // cross your fingers
    SwagGetMacrosResponse result = api.editDocumentDocxGetMacroInformation(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
[**SwagGetMacrosResponse**](SwagGetMacrosResponse.md)
...
try {
    // cross your fingers
    Blob result = api.editDocumentDocxRemoveAllComments(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
try {
    // cross your fingers
    Blob result = api.editDocumentDocxReplaceMulti(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
> Blob editDocumentDocxSetFormFields(reqConfig)
...
Map<String, Object> params = new Map<String, Object>{
    'reqConfig' => SwagDocxSetFormFieldsRequest.getExample()
};

try {
    // cross your fingers
    Blob result = api.editDocumentDocxSetFormFields(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **reqConfig** | [**SwagDocxSetFormFieldsRequest**](SwagDocxSetFormFieldsRequest.md)|  |
...
> SwagGetMacrosResponse editDocumentPptxGetMacroInformation(inputFile)
...
try {
    // cross your fingers
    SwagGetMacrosResponse result = api.editDocumentPptxGetMacroInformation(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
...
> SwagGetMacrosResponse editDocumentXlsxGetMacroInformation(inputFile)
...
try {
    // cross your fingers
    SwagGetMacrosResponse result = api.editDocumentXlsxGetMacroInformation(params);
    System.debug(result);
} catch (Swagger.ApiException e) {
    // ...handle your exceptions
}
